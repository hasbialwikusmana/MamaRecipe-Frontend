    ...
    <div className="2xl:container 2xl:mx-auto h-screen">
      ...
      >
        ...
        >
          ...
          <form className="w-1/2 max-sm:w-4/5 max-lg:w-3/4  flex flex-col justify-start">
            <label className="text-[#696F79] mb-1" htmlFor="email">
              Email
            </label>
            <input className="w-full bg-white border border-[#8692A6] rounded p-3 mb-4 text-sm focus:drop-shadow  focus:outline-primary" type="text" name="email" id="email" placeholder="examplexxx@gmail.com" />

            <label className="text-[#696F79] mb-1" htmlFor="password">
              Password
            </label>
            <input className="w-full bg-white border border-[#8692A6] rounded p-3 mb-4 text-sm focus:drop-shadow  focus:outline-primary" type="password" name="password" id="password" placeholder="Password" />
